...
const wordList = [
    ...
    // },
    // {word: "quidditch",
    //  question: "The wizarding national sport"
    // },
    // {word: "reducto",
...
//game functions
const inputs = document.querySelector('.tiles'),
...
function gamePlay(){
    ...
    let html = ''    // this part of code from https://www.codingnepalweb.com/word-guessing-game
...
inputs.addEventListener('click', () => answerTiles.focus())
